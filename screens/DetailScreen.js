        ...
        <View style={styles.content}>
          <View style={styles.infoRow}>
            <View style={styles.infoCard}>
              ...
              <Text style={styles.infoValue}>{program.tuition}</Text>
            </View>
            <View style={styles.infoCard}>
              <Text style={styles.infoLabel}>📅 Intake</Text>
              <Text style={styles.infoValue}>{program.intake}</Text>
            </View>
          </View>
          ...
          <TouchableOpacity style={styles.applyButton}>
            <Text style={styles.applyButtonText}>Apply Now via WayGood 🚀</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
    </SafeAreaView>
